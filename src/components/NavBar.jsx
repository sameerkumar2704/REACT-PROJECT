...
export default function NavBar() {
  ...
  return (
    <nav className=" h-[8vh]   max-sm:gap-x-0 max-lg:justify-between  px-8 py-14 box-border flex justify-center gap-x-96 items-center ">
      ...
      <ul
        className={twMerge(` lg:translate-x-0   z-20 max-lg:flex-col transition-all duration-300  max-lg:gap-5 max-lg:p-8 max-lg:justify-start max-lg:bg-sky-500 max-lg:fixed  max-lg:right-0 max-lg:top-0 max-lg:bottom-0 max-lg:h-full    text-xs font-semibold self-end   flex-1   uppercase text-white flex gap-x-8 justify-end
